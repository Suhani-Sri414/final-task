    ...
    return Container(
      decoration: const BoxDecoration(
        image: DecorationImage(
          image: AssetImage('assets/images/signupandloginbg.png'),fit: BoxFit.cover,
        ),
      ),
      child: Scaffold(
          ...
          children: [
            Container(
              ...
              child: const Text(
                'Mind',
                style: TextStyle(
                  color: Color.fromARGB(255, 31, 58, 95),fontSize: 33,fontWeight: FontWeight.bold,
                ),
              ),
            ),
            Container(
              ...
              child: const Text(
                'Ease',
                style: TextStyle(
                  color: Color.fromARGB(255, 33, 150, 84),fontSize: 33,fontWeight: FontWeight.bold,
                ),
              ),
            ),
            Container(
              ...
              child: const Text(
                ...
                style: TextStyle(
                  color: Color.fromARGB(255, 92, 114, 141),fontSize: 23,
                ),
              ),
            ),
                      ...
                      FormBuilderTextField(
                        ...
                        validator: FormBuilderValidators.compose([
                          ...
                          FormBuilderValidators.match(
                            ...
                            errorText:'Must have 6 chars including letter, number & symbol',
                          ),
                        ]),
                      ),
                      const SizedBox(height: 20),
                        ...
                        onPressed: () {
                          if (_formKey.currentState?.saveAndValidate() ?? false) {
                            ...
                            authController.login(
                              context,data['email'].trim(),data['password'].trim(),
                            );
                          }
                        },
                      ...
                      Row(
                        ...
                        children: [
                          ...
                          GestureDetector(
                            ...
                            child: const Text(
                              " Sign Up",
                              style: TextStyle(color: Color.fromARGB(255, 33, 150, 84),
